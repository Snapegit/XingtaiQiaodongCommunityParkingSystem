<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title">邢台市桥东区社区停车信息管理系统</div>
			...
			<div class="rotation_view">
				<mySwiper :type="3" :data="rotationList" :autoHeight="false" :autoplay="true"
					...
					<template #default="scope">
						<img :style='{"objectFit":"cover","width":"100%","height":"480px"}' :src="scope.row.value?$config.url + scope.row.value:''">
					</template>
				</mySwiper>
			</div>
			<router-view />
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			if(context?.$toolUtil.storageGet('frontSessionTable') == 'shequguanliyuan'){
...
<style lang="scss" scoped>
	...
	.index_top {
		...
		background: url(http://clfile.zggen.cn/20231025/03228bf47f0d403f91f089f28c50c428.png) repeat-x center top,#fff;
		width: 100%;
