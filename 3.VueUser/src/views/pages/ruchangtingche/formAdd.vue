			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="小时价格" prop="xiaoshijiage">
						<el-input class="list_inp" v-model="form.xiaoshijiage" placeholder="小时价格"
							 type="text" 							:readonly="!isAdd||disabledForm.xiaoshijiage?true:false" />
					</el-form-item>
				</el-col>
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		context?.$http({
			...
			if(json.hasOwnProperty('chepaihaoma') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
				form.value.chepaihaoma = json.chepaihaoma
				disabledForm.value.chepaihaoma = true;
			}
		})
	}
